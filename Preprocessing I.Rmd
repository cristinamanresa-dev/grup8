...
```
S'observa que practicament totes les variables tenen 3956 missings.
...
(fig <- plotly::plot_ly(train, x = ~"speechiness", y = ~"song_duration_ms", z = ~"loudness", size = 1) %>%
       add_markers())
```
