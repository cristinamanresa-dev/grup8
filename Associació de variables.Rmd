...
train_2
```
Es veu que tenim 13186 transaccions i 51 items.
...
test_2
```
Es veu que tenim 5649 transaccions i 48 items. Com en el train
...
rules <- apriori(train_2, parameter = list(supp = 0.01, conf = 0.8, minlen=2))
...
# Generar regles d'associació
rules <- apriori(test_2, parameter = list(supp = 0.01, conf = 0.8, minlen=2))
