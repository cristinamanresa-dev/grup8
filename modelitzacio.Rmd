...
```
 ...
 Basado en los datos, parece que algunas variables están en catalán
 Vamos a identificar y convertir las variables categóricas
...
test_predictions <- predict_test_set(final_model, test_data, train_data)

# Crear dataframe con resultados
results <- data.frame(
  row_id = 1:nrow(test_data),
  predicted_song_popularity = round(test_predictions, 1)  # Redondear si es necesario
)
